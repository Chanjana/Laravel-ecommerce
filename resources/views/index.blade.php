        ...
        <div class="row gy-3">
            ...
            <div class="col-xxl-10 col-lg-9">
                <div class="category-wrapper category-slider1 white-arrow category-arrow">
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                            <img src="assets/images/fashion/category/6.jpg" class="bg-img blur-up lazyload"
                                alt="category image">
                            <div class="category-content category-text-1">
                                <h3 class="theme-color">Jewellery</h3>
                                <span class="text-dark">Fashion</span>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                            <img src="assets/images/fashion/category/7.jpg" class="bg-img blur-up lazyload"
                                alt="category image">
                            <div class="category-content category-text-1">
                                <h3 class="theme-color">Books</h3>
                                <span class="text-dark">Stationery</span>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="row g-sm-4 g-3">
                ...
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/fashion/product/front/book1.jpg"
                                class="w-100 bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Books</span>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">3200 LKR</div>
                            ...
                            <a href="product/details.html" class="font-default">
                                <h5>Iron Flame (The Empyrean, 2)</h5>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/fashion/product/front/10.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">3000 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                            ...
                            <p class="font-light mb-sm-2 mb-0">Seller name</p>
                            <a href="product/details.html" class="font-default">
                                <h5>Wrangler Authentics Men's Long Sleeve Quilted Lined Flannel Shirt Jacket with Hood
                                </h5>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/fashion/product/front/img2.jpg"
                                class="w-100 bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Fashion</span>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            ...
                            <p class="font-light mb-sm-2 mb-0">Seller name</p>
                            <a href="product/details.html" class="font-default">
                                <h5>Nike mens Dry Park III Shorts</h5>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/shoe1.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Fashion</span>
                        <div class="label-block">
                            <span class="label label-theme">38% Off</span>
                        </div>
                        <div class="cart-wrap">
                            <ul>
                                <li>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">19500 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/book3.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Research Books</span>
                        <div class="label-block">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">5000 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                            ...
                            <p class="font-light mb-sm-2 mb-0">Seller name</p>
                            <a href="product/details.html" class="font-default">
                                <h5>Strategic Market Research</h5>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/fashion/product/front/12.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Fashion</span>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">5300 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/book2.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Research Books</span>
                        <div class="label-block">
                            <span class="label label-theme">35% Off</span>
                        </div>
                        <div class="cart-wrap">
                            <ul>
                                <li>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">8000 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">6000 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/fashion/product/front/23.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Fashion</span>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">2500 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                            ...
                            <p class="font-light mb-sm-2 mb-0">Seller name</p>
                            <a href="product/details.html" class="font-default">
                                <h5>Reebok Women's Jacket - Polar Fleece Sweatshirt Jacket - Lightweight Coat for Women
                                </h5>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/fashion/product/front/11.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Fashion</span>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">4000 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/jewel1.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Fashion</span>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">4500 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                            ...
                            <p class="font-light mb-sm-2 mb-0">Seller name</p>
                            <a href="product/details.html" class="font-default">
                                <h5> Four-Leaf Clover Jewelry Set</h5>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <a href="product/details.html">
                            <img src="assets/images/shoe2.jpg" class="w-100 bg-img blur-up lazyload"
                                alt="">
                        </a>
                        <div class="circle-shape"></div>
                        <span class="background-text">Fashion</span>
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            <div class="r-price">
                                <div class="theme-color">12000 LKR</div>
                                <div class="main-price">
                                    <ul class="rating mb-1 mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                            ...
                            <p class="font-light mb-sm-2 mb-0">Seller name</p>
                            <a href="product/details.html" class="font-default">
                                <h5>FuelCell SuperComp Elite v4</h5>
                            </a>
                        </div>
                    </div>
                </div>
