...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/favicon.ico') }}" type="image/x-icon">
    <meta name="theme-color" content="#b951ed">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Address:</b><span class="font-light"> ..... </span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@trif.in</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="shop.html" class="font-dark">Men</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Women</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Jewellery</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Books</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
