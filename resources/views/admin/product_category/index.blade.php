                                        ...
                                        <td
                                            ...
                                            <div class="flex gap-3">
                                                ...
                                                <form
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="rounded bg-indigo-100 px-2 py-1 ml-4 text-xs font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Delete</button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
