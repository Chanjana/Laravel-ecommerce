<x-app-layout>
    <div class="container pl-12 pb-16 mx-auto mt-20">
            ...
            <div class="flex items-center justify-center px-4 sm:px-0">
                ...
                <div class="px-4 sm:px-0">
                    <img src="{{ asset('assets/images/form_image.png') }}" class=" w-6=80 h-80 img-fluid blur-up lazyload "
                                            alt="logo">   
                ...
                <form method="post"
                    ...
                    <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                        ...
                        <button type="submit"
                            class="rounded-md bg-indigo-600 px-3 py-2 ml-4 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
                    </div>
                </form>
            </div>
